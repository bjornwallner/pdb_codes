...
float **matrix_nr(long nrl, long nrh, long ncl, long nch)
...
double **dconvert_matrix(double *a, long nrl, long nrh, long ncl, long nch)
...
float **matrix_nr(nrl,nrh,ncl,nch)
...
int **imatrix_nr(nrl,nrh,ncl,nch)
long nch,ncl,nrh,nrl;
/* allocate a int matrix with subscript range m[nrl..nrh][ncl..nch] */
{
	long i, nrow=nrh-nrl+1,ncol=nch-ncl+1;
