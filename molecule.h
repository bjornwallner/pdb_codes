#ifndef molecule_h
#define molecule_h
#include "/afs/pdc.kth.se/home/b/bjornw/source/c/pdb/ProQres/PROQRES/src/types/simple.h"
#include "/afs/pdc.kth.se/home/b/bjornw/source/c/nets/nets.h"
#define TRUE		1		/* Boolean definitions */
#define FALSE		0
#define	MAXATMS		50000		/* Maximum allowable atoms */
...
double fatness2(molecule *m,int verbose);
//double fatness_verbose(molecule *m);
